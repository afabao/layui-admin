...
Date: 2019-03-12 20:59:29
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for depot_inventory
-- ----------------------------
...
-- ----------------------------
-- Records of depot_inventory
-- ----------------------------

-- ----------------------------
-- Table structure for depot_order
-- ----------------------------
DROP TABLE IF EXISTS `depot_order`;
CREATE TABLE `depot_order` (
  `ID` varchar(32) NOT NULL,
  `ORDER_TYPE` int(20) NOT NULL,
  `GOODS_ID` varchar(32) NOT NULL,
  `GOODS_NUMBER` varchar(10) NOT NULL,
  `APPLY_USER` varchar(20) NOT NULL,
  `APPLY_TIME` datetime NOT NULL,
  `STATE` varchar(10) NOT NULL,
  `ORDER_AUDIT_USER` varchar(10) NOT NULL,
  `ORDER_AUDIT_TIME` datetime NOT NULL,
...
CREATE TABLE `purchase_ order` (
  ...
  `ORDER_AUDIT_USER` varchar(20) DEFAULT NULL,
  `ORDER_AUDIT_TIME` datetime(6) DEFAULT NULL,
  `PAY_AUDIT_USER` varchar(20) DEFAULT NULL,
  `PAY_AUDIT_TIME` datetime(6) DEFAULT NULL,
  `APPLY_DESCRIBE` varchar(20) DEFAULT NULL,
  `AUDIT_DESCRIBE` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;

-- ----------------------------
-- Records of purchase_ order
-- ----------------------------
...
INSERT INTO `sys_access_permission_test` VALUES ('1dc4c4fee8bc40adb85f5c5e07a62d5c', 'keeperCheck/*', 'authc,roleOr[仓库主管,admin]', '570', null, 'gameloft9', null, null, null);
INSERT INTO `sys_access_permission_test` VALUES ('2', '/index', 'anon', '2', '0', 'admin', '2017-12-25 16:41:08', 'admin', '2017-12-25 16:41:08');
INSERT INTO `sys_access_permission_test` VALUES ('21f1b05fef534390ac5be9842ad8268f', 'backlogByBuyerM/*', 'authc,roleOr[采购部领导,admin]', '783', null, 'gameloft9', null, null, null);
INSERT INTO `sys_access_permission_test` VALUES ('22d150a6deb64b7293995bed4d576fac', 'repository/*', 'authc,roleOr[仓库主管,仓库员工,admin]', '443', null, 'gameloft9', null, null, null);
...
INSERT INTO `sys_access_permission_test` VALUES ('a858648736e14b56aad507c8186f7e70', 'backlog/*', 'authc,roleOr[仓库主管,仓库员工,admin]', '338', null, 'gameloft9', null, null, null);
...
-- ----------------------------
-- Records of sys_material_goods_test
-- ----------------------------
...
INSERT INTO `sys_material_test` VALUES ('322a128cceb04b9ab9de96b19d4aa48c', '平头螺丝', '螺丝', '紧固');
...
INSERT INTO `sys_material_test` VALUES ('3aa15e71f64746dfa41d2e54ff514bfa', '沉头螺丝', '螺丝', '紧固');
...
INSERT INTO `sys_material_test` VALUES ('b0d0b41122ba482eba3a3282f79db1aa', '圆头螺丝', '螺丝', '紧固');
...
INSERT INTO `sys_menu_role_test` VALUES ('08ca5713fa2a4ee9ba96aa59944b8c03', '9b2fb915c2a24ed29de0661afda6ef0d', 'J/F9-+?', null, null, null, null);
...
INSERT INTO `sys_menu_role_test` VALUES ('41a72766f21148939578b58e664571ae', '9d495511d6944258a7ebf34312caa992', 'a6aea9a7a7104a34aeb71ad5c437dd9b', null, null, null, null);
...
INSERT INTO `sys_menu_role_test` VALUES ('55e09fead5e64f05a5e12e44e7cd53da', '9d495511d6944258a7ebf34312caa992', '4579b12040f64cc597896fde77982003', null, null, null, null);
INSERT INTO `sys_menu_role_test` VALUES ('571c7525eb2b4b0792ca87c49583252a', '44348c24848b46c9848af485839526e9', 'J/F9-+?', null, null, null, null);
...
INSERT INTO `sys_menu_role_test` VALUES ('64aa447fc5424900bea21812cf94ce96', '9d495511d6944258a7ebf34312caa992', 'J/F9-+?', null, null, null, null);
...
INSERT INTO `sys_menu_role_test` VALUES ('6e5ba6ef938547579099a9c2a075bf13', '44348c24848b46c9848af485839526e9', '4579b12040f64cc597896fde77982003', null, null, null, null);
...
INSERT INTO `sys_menu_role_test` VALUES ('9e4483176a8f41138cf8e7b7dcbaa582', '9b2fb915c2a24ed29de0661afda6ef0d', 'b1c3a938bdef49b98892cb6d9dcd537e', null, null, null, null);
INSERT INTO `sys_menu_role_test` VALUES ('a02c1ef224884ba48bd4bb8b8bd73f0a', '44348c24848b46c9848af485839526e9', 'a6aea9a7a7104a34aeb71ad5c437dd9b', null, null, null, null);
...
INSERT INTO `sys_menu_test` VALUES ('44348c24848b46c9848af485839526e9', '待办事项(仓库)', 'page/system/repository/backlog.html', 'backlog/*', 'icon-text', '5-1', null, '9d495511d6944258a7ebf34312caa992', '1', 'gameloft9', null, null, null);
...
INSERT INTO `sys_menu_test` VALUES ('9b2fb915c2a24ed29de0661afda6ef0d', '待办事项(采购)', 'page/system/purchase_order/backlogByBuyerM.html', 'backlogByBuyerM/*', 'icon-text', '4-2', null, 'e85ca213b98f4fbe880102f4487cd27e', '2', 'afabao', '2019-03-11 19:17:48', null, '2019-03-11 19:17:48');
INSERT INTO `sys_menu_test` VALUES ('9d495511d6944258a7ebf34312caa992', '仓库管理', '#', 'repository/*', 'icon-text', '5', null, null, '5', 'gameloft9', '2019-03-12 11:51:42', null, '2019-03-12 11:51:42');
...
INSERT INTO `sys_oper_log_test` VALUES ('0341ad8c294049dc86b6bf57931c1e03', '123', 'gameloft9', '127.0.0.1', 'add', '2019-03-11 11:08:01', '添加菜单');
...
INSERT INTO `sys_oper_log_test` VALUES ('07544a4f1b9c4a1c90968b3705446386', '123', 'gameloft9', '127.0.0.1', 'add', '2019-03-11 09:16:23', '提交订单申请');
INSERT INTO `sys_oper_log_test` VALUES ('07e11e7774f247a49d06b9f1f5fe1a50', '123', 'gameloft9', '127.0.0.1', 'add', '2019-03-11 07:57:18', '添加订单');
INSERT INTO `sys_oper_log_test` VALUES ('08416a38c9694973b31936ec1756b227', '123', 'gameloft9', '0:0:0:0:0:0:0:1', 'add', '2019-03-11 12:05:43', '删除原料商品');
INSERT INTO `sys_oper_log_test` VALUES ('08573c46d4eb4a8fb00fbe73633b11aa', '123', 'gameloft9', '0:0:0:0:0:0:0:1', 'add', '2019-03-11 12:47:14', '添加原料商品');
...
INSERT INTO `sys_oper_log_test` VALUES ('0868429238e247bdb4a735d376c3d707', '123', 'gameloft9', '127.0.0.1', 'add', '2019-03-11 09:30:26', '撤回申请');
...
INSERT INTO `sys_oper_log_test` VALUES ('0de6a89d767d41dfa89829a90fa646fe', '123', 'gameloft9', '127.0.0.1', 'add', '2019-03-11 06:05:48', '采购部领导审核订单');
...
INSERT INTO `sys_oper_log_test` VALUES ('167a893ab6ac47378e44a4f71d9762b6', '123', 'gameloft9', '127.0.0.1', 'add', '2019-03-11 06:02:14', '采购部领导审核订单');
INSERT INTO `sys_oper_log_test` VALUES ('16c16ad4c26f47e3ba1a6e9a9feb9bdb', '123', 'gameloft9', '127.0.0.1', 'upd', '2019-03-11 11:13:38', '更新菜单');
...
INSERT INTO `sys_oper_log_test` VALUES ('184e76ce09cf4f4696a0db4a3c598df9', '123', 'gameloft9', '127.0.0.1', 'add', '2019-03-12 03:52:58', '添加订单');
...
INSERT INTO `sys_oper_log_test` VALUES ('1a9ee32a1cfe4b8eae42ec6979b0db1d', '123', 'gameloft9', '127.0.0.1', 'add', '2019-03-12 03:53:13', '采购部领导审核订单');
INSERT INTO `sys_oper_log_test` VALUES ('1ac09e86df8d4534914d8f08f6ecb3f9', '123', 'gameloft9', '0:0:0:0:0:0:0:1', 'add', '2019-03-11 12:49:06', '添加原料商品');
INSERT INTO `sys_oper_log_test` VALUES ('1b9b7bc1730c45d4bb2835b40a37cf59', '123', 'gameloft9', '127.0.0.1', 'add', '2019-03-11 07:48:41', '添加订单');
...
INSERT INTO `sys_oper_log_test` VALUES ('1f7fe5ded8dd44a3823c3359eda2b99f', '123', 'gameloft9', '127.0.0.1', 'add', '2019-03-12 02:22:43', '添加原料商品');
...
INSERT INTO `sys_oper_log_test` VALUES ('2147e6e213524f0ba466a9e3ab189d33', '123', 'gameloft9', '127.0.0.1', 'add', '2019-03-11 07:57:24', '提交订单申请');
...
INSERT INTO `sys_oper_log_test` VALUES ('25bff774ca08419eadf1bd1cf84ab272', '123', 'gameloft9', '127.0.0.1', 'add', '2019-03-11 07:46:08', '采购部领导审核订单');
INSERT INTO `sys_oper_log_test` VALUES ('292148e337514d21812342fb7c48665e', '123', 'gameloft9', '127.0.0.1', 'upd', '2019-03-12 04:08:59', '更新菜单');
...
INSERT INTO `sys_oper_log_test` VALUES ('29f2b135f3c04cd1a41f9aeb192a85cf', '123', 'gameloft9', '0:0:0:0:0:0:0:1', 'add', '2019-03-11 12:49:10', '删除原料商品');
INSERT INTO `sys_oper_log_test` VALUES ('2a45624ec40844e28b19ef057f5faec6', '123', 'gameloft9', '127.0.0.1', 'add', '2019-03-11 09:14:02', '撤回申请');
...
INSERT INTO `sys_oper_log_test` VALUES ('2ce2a75e15854e62948d61634a8f5918', '123', 'gameloft9', '127.0.0.1', 'add', '2019-03-11 07:45:24', '提交订单申请');
INSERT INTO `sys_oper_log_test` VALUES ('2d218373ac5b4117ade345d0defe0bbe', '123', 'gameloft9', '0:0:0:0:0:0:0:1', 'add', '2019-03-11 12:50:28', '添加原料商品');
...
INSERT INTO `sys_oper_log_test` VALUES ('2de00c027a5045328d4917235f1eee07', '123', 'gameloft9', '0:0:0:0:0:0:0:1', 'add', '2019-03-11 12:57:55', '添加原料商品');
INSERT INTO `sys_oper_log_test` VALUES ('3012ae088d8b4b5fb7bc7ab12095c1ce', '123', 'gameloft9', '0:0:0:0:0:0:0:1', 'add', '2019-03-11 12:38:12', '添加原料商品');
INSERT INTO `sys_oper_log_test` VALUES ('318e184b04024f05b5dbc3321ee923da', '123', 'gameloft9', '127.0.0.1', 'add', '2019-03-12 03:53:04', '提交订单申请');
...
INSERT INTO `sys_oper_log_test` VALUES ('3498dd579fed4a8ebcc8ee65eff9bcb9', '123', 'gameloft9', '127.0.0.1', 'add', '2019-03-12 12:20:22', '撤回申请');
INSERT INTO `sys_oper_log_test` VALUES ('349e1cc3ddff45c59fa8d56cf85e2966', '123', 'gameloft9', '127.0.0.1', 'add', '2019-03-11 07:37:36', '采购部领导审核订单');
...
INSERT INTO `sys_oper_log_test` VALUES ('3aab61927369408fa3be89b39482aed3', '123', 'gameloft9', '0:0:0:0:0:0:0:1', 'add', '2019-03-11 12:53:31', '删除原料商品');
...
INSERT INTO `sys_oper_log_test` VALUES ('3c63873e65a64c969868e9d736401488', '123', 'gameloft9', '127.0.0.1', 'add', '2019-03-11 11:10:46', '添加用户');
...
INSERT INTO `sys_oper_log_test` VALUES ('3cfba26293db457b8ec0f60ad8fc98a4', '123', 'gameloft9', '127.0.0.1', 'add', '2019-03-11 07:50:20', '采购部领导审核订单');
...
INSERT INTO `sys_oper_log_test` VALUES ('439174b576c446f380fac289e470baa8', '123', 'gameloft9', '0:0:0:0:0:0:0:1', 'add', '2019-03-11 12:05:41', '删除原料商品');
...
INSERT INTO `sys_oper_log_test` VALUES ('469478e9d9574105ac5aae7724ff5430', '123', 'gameloft9', '127.0.0.1', 'add', '2019-03-11 11:09:03', '添加角色');
...
INSERT INTO `sys_oper_log_test` VALUES ('47bdaef33a614bd09c64685910134242', '123', 'gameloft9', '0:0:0:0:0:0:0:1', 'add', '2019-03-11 12:36:06', '添加原料商品');
...
INSERT INTO `sys_oper_log_test` VALUES ('49dfadbc395540c0b541d110400ebb71', '123', 'gameloft9', '127.0.0.1', 'del', '2019-03-12 04:08:39', '删除菜单');
INSERT INTO `sys_oper_log_test` VALUES ('49fec247966d4a02b3af58024074218f', '123', 'gameloft9', '127.0.0.1', 'add', '2019-03-11 07:53:05', '提交订单申请');
...
INSERT INTO `sys_oper_log_test` VALUES ('4b6bce8e51724b0eac13390f98b61877', '123', 'gameloft9', '0:0:0:0:0:0:0:1', 'add', '2019-03-11 12:06:08', '删除订单申请');
...
INSERT INTO `sys_oper_log_test` VALUES ('4f2d5d6d6bd949a7828a47439fb9a553', '123', 'gameloft9', '0:0:0:0:0:0:0:1', 'add', '2019-03-12 09:09:59', '提交订单申请');
...
INSERT INTO `sys_oper_log_test` VALUES ('51e19005e89041869608a5846bcca6af', '123', 'gameloft9', '127.0.0.1', 'add', '2019-03-11 11:19:04', '添加菜单');
INSERT INTO `sys_oper_log_test` VALUES ('52fd0908d24849bf8912e211eb842304', '123', 'gameloft9', '0:0:0:0:0:0:0:1', 'add', '2019-03-11 12:57:59', '删除原料商品');
INSERT INTO `sys_oper_log_test` VALUES ('5318302f13bf4a6bbf1662d958a932a5', '123', 'gameloft9', '127.0.0.1', 'add', '2019-03-11 09:07:59', '提交订单申请');
...
INSERT INTO `sys_oper_log_test` VALUES ('53588b5fc88644d182c2e60d5a0446bf', '123', 'gameloft9', '127.0.0.1', 'add', '2019-03-11 09:24:17', '撤回申请');
...
INSERT INTO `sys_oper_log_test` VALUES ('551a67a40544448791d6c9f61e57cb02', '123', 'gameloft9', '0:0:0:0:0:0:0:1', 'add', '2019-03-11 12:07:25', '添加原料');
INSERT INTO `sys_oper_log_test` VALUES ('5527ec3191a1481d9978501c9a29e610', '123', 'gameloft9', '0:0:0:0:0:0:0:1', 'add', '2019-03-11 12:43:51', '添加原料商品');
...
INSERT INTO `sys_oper_log_test` VALUES ('56f30ee2ab484109acde11145c737d68', '123', 'gameloft9', '127.0.0.1', 'add', '2019-03-11 11:09:11', '添加角色');
...
INSERT INTO `sys_oper_log_test` VALUES ('583db241250941e2967995ce09a23b8a', '123', 'gameloft9', '127.0.0.1', 'add', '2019-03-12 04:07:49', '添加菜单');
...
INSERT INTO `sys_oper_log_test` VALUES ('5e666127d7494402b25d2a6f863f7857', '123', 'gameloft9', '0:0:0:0:0:0:0:1', 'add', '2019-03-11 08:15:45', '提交订单申请');
INSERT INTO `sys_oper_log_test` VALUES ('61831691da15488faa876965e4f71936', '123', 'gameloft9', '0:0:0:0:0:0:0:1', 'add', '2019-03-11 08:15:41', '添加订单');
...
INSERT INTO `sys_oper_log_test` VALUES ('64f72046cfd942f68718301dba2531bd', '123', 'gameloft9', '0:0:0:0:0:0:0:1', 'add', '2019-03-11 12:08:12', '添加原料');
...
INSERT INTO `sys_oper_log_test` VALUES ('74a89baaab344ac8be33f28772e77c20', '123', 'gameloft9', '0:0:0:0:0:0:0:1', 'add', '2019-03-12 01:33:09', '添加原料商品');
...
INSERT INTO `sys_oper_log_test` VALUES ('77ece771ee3247e3bd4ecf4b3590201f', '123', 'gameloft9', '0:0:0:0:0:0:0:1', 'add', '2019-03-11 12:45:58', '添加原料商品');
...
INSERT INTO `sys_oper_log_test` VALUES ('7b2c844d4e1d4851b6e4392ea7392552', '123', 'gameloft9', '127.0.0.1', 'add', '2019-03-12 02:04:11', '添加原料商品');
...
INSERT INTO `sys_oper_log_test` VALUES ('7ee3dc8cefef4effbf0a9dbdf1d592a7', '123', 'gameloft9', '0:0:0:0:0:0:0:1', 'add', '2019-03-11 12:44:34', '添加原料商品');
INSERT INTO `sys_oper_log_test` VALUES ('7f2cd13cbdb9496ab1e43c0f26bd6a4d', '123', 'gameloft9', '127.0.0.1', 'add', '2019-03-12 02:48:33', '添加原料商品');
...
INSERT INTO `sys_oper_log_test` VALUES ('844c5d2f0159425f82058dfd9ab6464f', '123', 'gameloft9', '0:0:0:0:0:0:0:1', 'add', '2019-03-11 12:07:43', '添加原料');
...
INSERT INTO `sys_oper_log_test` VALUES ('852497f5738d454d8599124f89075a72', '123', 'gameloft9', '0:0:0:0:0:0:0:1', 'add', '2019-03-11 12:37:55', '添加原料商品');
...
INSERT INTO `sys_oper_log_test` VALUES ('8a286462ca5247a485c5337366b8b918', '123', 'gameloft9', '0:0:0:0:0:0:0:1', 'add', '2019-03-11 12:44:06', '添加原料商品');
...
INSERT INTO `sys_oper_log_test` VALUES ('8afe8cf1fa15443a903cb8641ddaa377', '123', 'gameloft9', '127.0.0.1', 'add', '2019-03-12 02:21:42', '添加原料商品');
INSERT INTO `sys_oper_log_test` VALUES ('8b3a9c51db334cbbaee6de57e748b594', '123', 'gameloft9', '127.0.0.1', 'add', '2019-03-12 02:22:09', '添加原料商品');
INSERT INTO `sys_oper_log_test` VALUES ('8b7de752377e4a7ea3d28041ff971833', '123', 'gameloft9', '127.0.0.1', 'add', '2019-03-11 11:12:02', '添加用户');
...
INSERT INTO `sys_oper_log_test` VALUES ('8cd2ac6ae8a54f3d9b0418275a064f79', '123', 'gameloft9', '127.0.0.1', 'add', '2019-03-12 02:18:53', '添加订单');
...
INSERT INTO `sys_oper_log_test` VALUES ('8e67dd838e5d4395bf39a82cbb79954f', '123', 'gameloft9', '127.0.0.1', 'upd', '2019-03-11 11:19:39', '更新菜单');
INSERT INTO `sys_oper_log_test` VALUES ('9001a5cdeef4497d9ea3541d7a6b550f', '123', 'gameloft9', '127.0.0.1', 'add', '2019-03-12 12:27:41', '提交订单申请');
INSERT INTO `sys_oper_log_test` VALUES ('916ff008fb7a42d09b02702ea8c7bb69', '123', 'gameloft9', '127.0.0.1', 'add', '2019-03-11 09:30:09', '提交订单申请');
INSERT INTO `sys_oper_log_test` VALUES ('92c027fe76f44858a6155c2d7a443cd3', '123', 'gameloft9', '0:0:0:0:0:0:0:1', 'add', '2019-03-11 12:53:22', '添加原料商品');
...
INSERT INTO `sys_oper_log_test` VALUES ('95cb5374838a4afcaaca20122b30c996', '123', 'gameloft9', '127.0.0.1', 'add', '2019-03-12 12:19:00', '提交订单申请');
...
INSERT INTO `sys_oper_log_test` VALUES ('9acd9893520e4225acb52e14b2dfe979', '123', 'gameloft9', '0:0:0:0:0:0:0:1', 'add', '2019-03-12 09:09:39', '添加订单');
INSERT INTO `sys_oper_log_test` VALUES ('9ca5c9a03ad144679f55a7f521fad002', '123', 'gameloft9', '127.0.0.1', 'upd', '2019-03-11 11:12:19', '更新菜单');
...
INSERT INTO `sys_oper_log_test` VALUES ('a1488b2ef49342c191bca7f94701cf88', '123', 'gameloft9', '127.0.0.1', 'add', '2019-03-12 02:49:40', '删除订单申请');
INSERT INTO `sys_oper_log_test` VALUES ('a20a594ac77f42c591e0e42547caaf3d', '123', 'gameloft9', '0:0:0:0:0:0:0:1', 'add', '2019-03-11 12:50:31', '删除原料商品');
...
INSERT INTO `sys_oper_log_test` VALUES ('a3ec641b8733412cb6d05e3d8ba004b0', '123', 'gameloft9', '127.0.0.1', 'add', '2019-03-12 02:22:55', '添加原料商品');
INSERT INTO `sys_oper_log_test` VALUES ('a46934ff65bc42099d11a07745ff28e1', '123', 'gameloft9', '0:0:0:0:0:0:0:1', 'add', '2019-03-11 12:05:46', '删除原料商品');
...
INSERT INTO `sys_oper_log_test` VALUES ('a7b4ee94842f4707995d6c36a03c7289', '123', 'gameloft9', '127.0.0.1', 'add', '2019-03-11 07:49:55', '提交订单申请');
...
INSERT INTO `sys_oper_log_test` VALUES ('a9108aa211964405848a9471018392ed', '123', 'gameloft9', '0:0:0:0:0:0:0:1', 'add', '2019-03-11 12:46:05', '删除原料商品');
...
INSERT INTO `sys_oper_log_test` VALUES ('ac7e6863afb9409684ee77238740c688', '123', 'gameloft9', '127.0.0.1', 'add', '2019-03-11 07:26:12', '提交订单申请');
INSERT INTO `sys_oper_log_test` VALUES ('ac9c182621034d8a98d5123416fd2fe0', '123', 'gameloft9', '127.0.0.1', 'add', '2019-03-12 02:21:20', '添加原料商品');
...
INSERT INTO `sys_oper_log_test` VALUES ('bb6d651a7a6b42368a7e84245b0d9c85', '123', 'gameloft9', '0:0:0:0:0:0:0:1', 'add', '2019-03-11 08:43:14', '采购部领导审核订单');
...
INSERT INTO `sys_oper_log_test` VALUES ('bda986ca014446588983d05be35641c8', '123', 'gameloft9', '0:0:0:0:0:0:0:1', 'add', '2019-03-11 12:40:17', '添加原料商品');
...
INSERT INTO `sys_oper_log_test` VALUES ('c633aaf0d7c645148124d3a74c3adf0b', '123', 'gameloft9', '127.0.0.1', 'upd', '2019-03-11 11:19:19', '更新菜单');
INSERT INTO `sys_oper_log_test` VALUES ('c7ddfc22c1a047398114d206f11cd6e7', '123', 'gameloft9', '127.0.0.1', 'add', '2019-03-11 09:22:54', '提交订单申请');
INSERT INTO `sys_oper_log_test` VALUES ('c862c359b36148dda232717b53ddf616', '123', 'gameloft9', '127.0.0.1', 'add', '2019-03-11 06:07:22', '采购部领导审核订单');
...
INSERT INTO `sys_oper_log_test` VALUES ('cd33f92d2bcd416a93ee2611849ee27f', '123', 'gameloft9', '0:0:0:0:0:0:0:1', 'add', '2019-03-11 12:36:25', '添加原料商品');
...
INSERT INTO `sys_oper_log_test` VALUES ('d06110377edd443d96d4e0c6ae9f001f', '123', 'gameloft9', '127.0.0.1', 'upd', '2019-03-11 11:17:49', '更新菜单');
...
INSERT INTO `sys_oper_log_test` VALUES ('d7fa71eadba54b1398288c69d3a9a003', '123', 'gameloft9', '127.0.0.1', 'add', '2019-03-12 02:48:20', '添加原料商品');
...
INSERT INTO `sys_oper_log_test` VALUES ('db4f07b6a44a4ff6a5fe224c2070bb8f', '123', 'gameloft9', '127.0.0.1', 'add', '2019-03-11 09:07:52', '添加订单');
INSERT INTO `sys_oper_log_test` VALUES ('dd243a30f2f5409f9ec5b565481239ac', '123', 'gameloft9', '127.0.0.1', 'add', '2019-03-11 07:54:11', '添加订单');
INSERT INTO `sys_oper_log_test` VALUES ('dd292487ed72426a9fa0409aa124ba8b', '123', 'gameloft9', '0:0:0:0:0:0:0:1', 'add', '2019-03-12 10:12:30', '添加订单');
INSERT INTO `sys_oper_log_test` VALUES ('dda1b10c12be4416ba77a6c16459db72', '123', 'gameloft9', '127.0.0.1', 'add', '2019-03-12 04:08:44', '添加菜单');
...
INSERT INTO `sys_oper_log_test` VALUES ('e72bcd966bad484caf1108696b1f9442', '123', 'gameloft9', '127.0.0.1', 'add', '2019-03-11 09:16:38', '撤回申请');
...
INSERT INTO `sys_oper_log_test` VALUES ('ea8f3b4aed914bd6a6a4b899e42db7af', '123', 'gameloft9', '127.0.0.1', 'add', '2019-03-11 07:55:26', '提交订单申请');
INSERT INTO `sys_oper_log_test` VALUES ('eb146530d9ea4991840567c217da5be5', '123', 'gameloft9', '0:0:0:0:0:0:0:1', 'add', '2019-03-12 01:26:06', '添加原料商品');
INSERT INTO `sys_oper_log_test` VALUES ('eb1f50503dda45959589b15a72a84c9e', '123', 'gameloft9', '127.0.0.1', 'upd', '2019-03-11 11:32:19', '更新菜单');
...
INSERT INTO `sys_oper_log_test` VALUES ('ee9c13fc286547a79cf6ccc7f0b104bd', '123', 'gameloft9', '0:0:0:0:0:0:0:1', 'add', '2019-03-11 12:37:33', '添加原料商品');
...
INSERT INTO `sys_oper_log_test` VALUES ('f2e4d5c30ff64054b705a97c134adff9', '123', 'gameloft9', '127.0.0.1', 'add', '2019-03-12 02:22:30', '添加原料商品');
...
INSERT INTO `sys_oper_log_test` VALUES ('f359900484834fba9a996db726e64b30', '123', 'gameloft9', '127.0.0.1', 'add', '2019-03-12 02:48:09', '添加原料商品');
INSERT INTO `sys_oper_log_test` VALUES ('f446a8ede8b040bc944de037cd6240b5', '123', 'gameloft9', '127.0.0.1', 'add', '2019-03-11 07:58:22', '提交订单申请');
INSERT INTO `sys_oper_log_test` VALUES ('f4780c82d5dc4876ba07089b2b1e64e2', '123', 'gameloft9', '127.0.0.1', 'add', '2019-03-11 07:52:57', '添加订单');
...
INSERT INTO `sys_oper_log_test` VALUES ('f6032f3e4b5440a68043b6998853261f', '123', 'gameloft9', '127.0.0.1', 'upd', '2019-03-12 03:51:43', '更新菜单');
...
INSERT INTO `sys_oper_log_test` VALUES ('f9a48a56cd7a41f891f4ee05d9ec45cd', '123', 'gameloft9', '0:0:0:0:0:0:0:1', 'add', '2019-03-11 12:39:13', '添加原料商品');
...
INSERT INTO `sys_oper_log_test` VALUES ('fba66aa13f1643a99acf73452a021dfc', '123', 'gameloft9', '127.0.0.1', 'upd', '2019-03-11 11:13:20', '更新菜单');
...
INSERT INTO `sys_oper_log_test` VALUES ('fc41c5cce65e457fba9c46cc33ba3da1', '123', 'gameloft9', '0:0:0:0:0:0:0:1', 'add', '2019-03-11 12:47:18', '添加原料商品');
...
CREATE TABLE `sys_purchase_order_test` (
  ...
  `AUDIT_STATE` varchar(10) NOT NULL,
  `ORDER_AUDIT_USER` varchar(10) DEFAULT NULL,
  `ORDER_AUDIT_TIME` datetime DEFAULT NULL,
  `PAY_AUDIT_USER` varchar(10) DEFAULT NULL,
  `PAY_AUDIT_TIME` datetime DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `sys_purchase_order_test` VALUES ('75d383f2beaf42e4b922387811b98696', '045d9d91125a469a804c86dd4cfa2cd0', '3aa15e71f64746dfa41d2e54ff514bfa', '螺丝', '沉头螺丝', '315faa5d32b244ed99bb45a8bc70566d', '广州伯拉汽车零部件有限公司', '200', '120', 'gameloft9', '2019-03-12 12:27:41', '待审核', null, null, null, null, '待付款', '文认为', null);
...
INSERT INTO `sys_role_test` VALUES ('4579b12040f64cc597896fde77982003', '仓库主管', '0', '0', 'gameloft9', '2019-03-11 19:09:23', null, '2019-03-11 19:09:23');
...
INSERT INTO `sys_role_test` VALUES ('a6aea9a7a7104a34aeb71ad5c437dd9b', '仓库员工', '0', '0', 'gameloft9', '2019-03-11 19:09:24', null, '2019-03-11 19:09:24');
...
-- ----------------------------
INSERT INTO `sys_supplier_goods_test` VALUES ('7c91a9ca1b5e438b87a39ea2087928c6', '1db3f80dd5134344809b69718bb73690', '1c3da2c5d97e4c28bf9404346d3a3997', '12');
INSERT INTO `sys_supplier_goods_test` VALUES ('c4952a1cb8124144aa435c8e4d92705f', '1db3f80dd5134344809b69718bb73690', 'b134f0eb3d594c0d9c55b09561338f97', '15');
INSERT INTO `sys_supplier_goods_test` VALUES ('6c461415d3274a538b6be9d80a6ad123', '1db3f80dd5134344809b69718bb73690', '3a5710e490d046479975302c31473dc6', '20');
INSERT INTO `sys_supplier_goods_test` VALUES ('07ae220b075a440891987a444a2c8b3a', '25ef61dbca5841dd9e35214500194876', '322a128cceb04b9ab9de96b19d4aa48c', '0.5');
INSERT INTO `sys_supplier_goods_test` VALUES ('fc1d80b5bc664a3bab14652569153c0a', '25ef61dbca5841dd9e35214500194876', 'b134f0eb3d594c0d9c55b09561338f97', '20');
INSERT INTO `sys_supplier_goods_test` VALUES ('1c8bfd4950974b019a6a4304543daf68', '2c631efa17aa41b3a0d858def53fbf5f', '423dffdd98a84885a835ee3c9ab07fb1', '23');
INSERT INTO `sys_supplier_goods_test` VALUES ('9449b644b13049de8f0389ef8a785797', '315faa5d32b244ed99bb45a8bc70566d', '6ea095efef69445fb292fc0e8fb9cf39', '10');
INSERT INTO `sys_supplier_goods_test` VALUES ('ff0e7551a90c4e6592eb1545099437b4', '315faa5d32b244ed99bb45a8bc70566d', '3aa15e71f64746dfa41d2e54ff514bfa', '0.6');
INSERT INTO `sys_supplier_goods_test` VALUES ('8674c244719b4e1a805e7259bd792738', '3b6a72f6da944ad881313c57598f0d79', '3dc21eaa6e1b480fa77073f6ba866eae', '10');
INSERT INTO `sys_supplier_goods_test` VALUES ('13050130319241ea8d4d550dbd82975e', '4b1a44361a7e44f980462a398398e90a', '1c3da2c5d97e4c28bf9404346d3a3997', '13');
INSERT INTO `sys_supplier_goods_test` VALUES ('a77716a2b20e4918a7d696df4fea1570', '4b1a44361a7e44f980462a398398e90a', '3a5710e490d046479975302c31473dc6', '14');
INSERT INTO `sys_supplier_goods_test` VALUES ('a9180dd4d3fa465bbeeb7d098f8b203e', '4b1a44361a7e44f980462a398398e90a', '3f9bb5f2783146dc937c8136fb91ed30', '15');
...
INSERT INTO `sys_user_role_test` VALUES ('69380b1e389944fe8168e434cb7738b9', '07144b06c79c49aab6d95333dfe482c5', 'a6aea9a7a7104a34aeb71ad5c437dd9b');
...
INSERT INTO `sys_user_role_test` VALUES ('f71eb42503554bf8802613c691201b15', 'a9d05e68ad56497894bc38b08ec5ce3b', '4579b12040f64cc597896fde77982003');
...
-- ----------------------------
INSERT INTO `user_test` VALUES ('07144b06c79c49aab6d95333dfe482c5', 'keeper', '123456', '李四', '0', '13405918222', null, '9542aa6ef8284e4d8be36d3f9faeeac9', '仓库', null, null);
...
INSERT INTO `user_test` VALUES ('a9d05e68ad56497894bc38b08ec5ce3b', 'keeperM', '123456', '李四领导', '0', '13405918333', null, '9542aa6ef8284e4d8be36d3f9faeeac9', '仓库', null, null);
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` EVENT `evt_init_db` ON SCHEDULE EVERY 20 MINUTE STARTS '2019-03-04 10:03:45' ON COMPLETION PRESERVE ENABLE DO call prc_init_db()
;;
DELIMITER ;
